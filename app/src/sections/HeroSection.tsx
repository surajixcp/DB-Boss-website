          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className={`max-w-2xl transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <a href="https://expo.dev/accounts/surajiace/projects/matkaking/builds/8d4366ca-c474-4e43-bfba-5d14176f47e8" download target="_blank" rel="noopener noreferrer" className="btn-primary flex items-center justify-center gap-2 text-white">
